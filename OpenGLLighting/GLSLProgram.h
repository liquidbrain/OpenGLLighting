...
public:
    ...
    GLSLProgram(const GLSLProgram& rhs) = delete;               // copy constructor
    GLSLProgram(const GLSLProgram&& rhs) = delete;              // move constructor
    GLSLProgram& operator=(const GLSLProgram& rhs) = delete;    // copy assignment operator
    GLSLProgram& operator=(const GLSLProgram&& rhs) = delete;   // move assignment operator
